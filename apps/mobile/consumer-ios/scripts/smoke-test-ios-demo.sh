...
PROJECT_PATH="$ROOT_DIR/ConsumerIOSDemo.xcodeproj"
DERIVED_DATA_PATH="${TMPDIR%/}/consumer-ios-demo-derived"
...
xcodebuild \
  ...
  -scheme ConsumerIOSDemo \
  -destination "generic/platform=iOS Simulator" \
  -derivedDataPath "$DERIVED_DATA_PATH" \
  build >/tmp/consumer-ios-demo-build.log
