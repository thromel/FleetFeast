...
import {
  createPushFallbackNotifierFromEnv,
  type PushFallbackNotifier,
  type PushFallbackTarget,
} from "./push-fallback.js";
...
export function createRealtimeGatewayServer(options: RealtimeGatewayOptions = {}): RealtimeGateway {
  ...
  async function publishToChannel(channel: string, envelope: RealtimeEnvelope): Promise<void> {
...
export function createRealtimeGatewayServerFromEnv(): RealtimeGateway {
